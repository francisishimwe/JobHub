-- Migration: Create resources table for Q&A and Interview preparation
-- Date: 2025-04-15
...
CREATE TABLE IF NOT EXISTS resources (
    ...
    category VARCHAR(50) NOT NULL, -- 'Q&A' or 'Interview'
...
CREATE INDEX IF NOT EXISTS idx_resources_sort_order ON resources(sort_order ASC, created_at DESC);
