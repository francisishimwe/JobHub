        ...
        <main className='container mx-auto px-4 py-12'>
            ...
            {[
              {
                ...
                quote: 'RwandaJobHub helped me find my dream job in just 2 weeks! The platform is easy to use and the job listings are high quality.'
              },
              {
                id: 2,
                ...
                quote: 'We have hired over 20 qualified candidates through RwandaJobHub. The platform has streamlined our recruitment process.'
              }
            ].map((testimonial) => (
          ...
          <div className='bg-gradient-to-r from-blue-600 to-purple-600 rounded-2xl p-12 text-center text-white'>
            ...
            <p className='text-xl mb-8 opacity-90'>
              Have you found success through RwandaJobHub? We would love to hear your story!
            </p>
            ...
            <div className='flex items-start gap-3'>
              ...
              <div>
                ...
                <p className='text-blue-700 text-sm'>
                  ...
                  Upload photos to the /public/testimonials/ folder
                  and update testimonials in admin panel.
                </p>
              </div>
            </div>
          </div>
