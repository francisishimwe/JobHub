...
import { Search, FileText, Clock, Star, Building2, Filter, X } from 'lucide-react'
...
export default function ViewExamsPage() {
  ...
  const fetchResources = async () => {
    try {
      const response = await fetch('/api/exam-resources?category=WRITTEN_EXAM')
      const data = await response.json()
      setResources(data.resources || [])
      
      // Extract unique institutions
      const uniqueInstitutions = [...new Set((data.resources || []).map((r: ExamResource) => r.institution))] as string[]
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Access comprehensive exam materials and past papers for Rwanda's top institutions
            </p>
          </div>
            ...
            <div className="text-center py-16">
              ...
              <p className="text-gray-600 mb-4">
                {hasActiveFilters 
                  ...
                  : 'No exam resources are available at the moment'
                }
              </p>
              {hasActiveFilters && (
