...
interface InternalApplicationModalProps {
  open: boolean
...
export function InternalApplicationModal({ 
  open, 
  onOpenChange, 
  jobId, 
  jobTitle 
}: InternalApplicationModalProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const response = await fetch('/api/apply-internal', {
        method: 'POST',
        body: submissionData,
      })
