        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-3 md:gap-4">
          ...
          <div className="flex flex-row gap-2 shrink-0">
            ...
            <Button
              ...
              className="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 text-xs md:text-sm font-medium transition-all duration-200 hover:scale-105 hover:shadow-lg lg:hover:shadow-xl whitespace-nowrap"
            ...
            <Button
              ...
              className="gap-1 px-3 py-2 text-xs md:text-sm transition-all duration-200 hover:scale-105 hover:bg-green-50 hover:border-green-300 hover:text-green-700 lg:hover:shadow-md whitespace-nowrap"
