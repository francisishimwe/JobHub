...
📢 *Follow our WhatsApp channel:* https://chat.whatsapp.com/250783074056`
  ...
  return (
    <div className="block">
      <div className={`rounded-2xl border bg-white border-blue-100 pt-6 p-4 md:p-6 shadow-sm transition-all duration-300 hover:-translate-y-1 hover:shadow-md active:scale-105 border-l-4 ${getJobTypeBorderColor()} animate-fade-in`}>
