...
export function InfolinksAds() {
  ...
  useEffect(() => {
    ...
    // Delay loading to ensure analytics scripts load first
    const loadAds = () => {
      ...
      if (!isDashboard && 
        ...
        try {
          ...
          console.warn('Error loading Infolinks ads:', error)
        }
      }
    }

    // Delay loading to ensure analytics fire first (1.5 seconds after page load)
